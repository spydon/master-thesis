...
JPF was used to test the idea and state transitioning of the application. It's a very simplified
version of the real system that still contains all the important Copy-on-Write core concepts and the 
assumptions that have been made in the model. This simplified version could then be automatically
...
type of system architecture and underlying persistent storage.
