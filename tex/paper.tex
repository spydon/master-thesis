...
With this said there is no comparisons of for example different databases, protocols or API
...
working on the same data set at the same time. Such problems could be race conditions or
...
refers to the same binary files until they are changed.
