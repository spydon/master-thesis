...
\item[SuperAgent]
\fix Add citation to SuperAgent
is a small HTTP request library which can be used from client-side Javascript or as a node.js
module. It is used to form the requests to the REST API from the front-end, which can be seen in
Figure~\ref{fig:tech_stack} (Arrow 1 and 2).
