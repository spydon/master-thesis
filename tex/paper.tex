...
RAM. The results that will be analysed are latency and load of the server as that will give a fair
judgement of how well the system can perform on any given machine.
...
\fix Add graphs of load testing etc
