...
\begin{itemize}
    \item[] c - Container
        \subitem Represents a structure that symbolises a folder in a virtual file system
    \item[] f - File
        \subitem A file in the system 
    \item[] p - Pointer
        \subitem A pointer to a file in the system 
    \item[] u - User
        \subitem A user in the system
    \item[] a - Access property
        \subitem Granted access to container
    \item[] A[u,c] - Access matrix
        \subitem Describes what containers the users in the system can access 
\end{itemize}
...
\fix Maybe a short description of full copy, as opposed to copy-on-write
...
\section{JPF}
\fix Not sure where to put this section or if it's even relevant any more, maybe skip JPF and put
the entities under implementation -> design
\subsection{Entities}
\begin{figure}[htp] \centering{
