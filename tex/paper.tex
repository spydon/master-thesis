...
\fix Describe the different CDN mechanisms, like signed cookies and urls

There are three different ways, that this implementation make use of, to make sure that 
the CDNs serve content in a private manner. The first two is signed URLs and signed cookies, and 
