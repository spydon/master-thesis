...
In these papers the foundation was laid for how to model a computer system to be able to analyse 
the security of a system. Furthermore this paper was also inspired by Biba, \textit{Integrity 
