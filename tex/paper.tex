...
it can affect the system's scalability. 
...
This section describes how different operations can be expected to affect the data in the system.
...
The predicates in (\ref{eq:fileread}) are used in several places and are therefore named \textit{*}.
