...
evaluated. The technique is shown to be quite efficient (scalable to >6000 simultaneous active
...
contrast to other EA studios like DICE. Currently Uprise has a lot of focus on developing companion
apps and a new form of menu systems.
...
object-oriented programming~\cite{SCALA}.  
